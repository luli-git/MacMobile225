  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                        ...
                        child: Row(
                          children: <Widget>[
                            Container(
                              ...
                              child: new Text(
                                  "Featured Events", style: TextStyle(
                          ...
                          children: <Widget>[
                            Container(
                                child: Column(
                                  children: <Widget>[
                                    Container(
                                        child: Text(event1Start,
                                          style: TextStyle(fontSize: 18),
                                          textAlign: TextAlign.center,)
                                    ), Container(
                                        child: Text(event1End,
                          ...
                          children: <Widget>[
                            Container(
                                child: Column(
                                  children: <Widget>[
                                    Container(
                                        child: Text(event2Start,
                                          style: TextStyle(fontSize: 18),
                                          )
                                    ), Container(
                                        child: Text(event2End,
                                          style: TextStyle(fontSize: 16),
                                          )
                                    )
                                  ],
                ...
                child: Column(
                  children: <Widget>[
                    Container(
                      child: Row(
                    children: <Widget>[
                      Container(margin: const EdgeInsets.fromLTRB(5.0,10.0,5.0,10.0),
                        child: new Text("Dining Favorites", style: TextStyle(
                            fontWeight: FontWeight.normal, fontSize: 22
                        )),
                      ...
                      Align(
                          ...
                          child:  PopupMenuButton<String>(
                              ...
                              itemBuilder: (BuildContext context) {
                                return DiningConstants.choices.map((String choice) {
                                  return PopupMenuItem<String>(
                                    value: choice,
                                    child: Text(choice),
                                  );
      ...
      child: SafeArea(
          ...
          bottom: false,
          child: Padding(
            padding: const EdgeInsets.only(left: 5.0, top: 10.0, bottom: 10.0, right: 0.0),
            child: Row(
              ...
              children: <Widget>[
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: new DecorationImage(image: new AssetImage ( "assets/images/cafemacbeauti.jpeg",
                    ),
                    fit: BoxFit.fill,
                    ) 
                  ),
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Text( "Cafe Mac", style: TextStyle(fontSize: 21.0, fontFamily: 'Lora')),
                        ...
                        Text("7:30-9:30 | 11:00-13:30 | 17:00-20:00",
            ...
            child: Row(
              ...
              children: <Widget>[
                Container(
                  ...
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(5.0),
                    image: new DecorationImage(image: new AssetImage ( "assets/images/" + dining2Image,
                    ),
                    fit: BoxFit.fill,
                    ) 
                  ),
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        Text(dining2, style: TextStyle(fontSize: 21.0, fontFamily: 'Lora')),
                        const Padding(padding: EdgeInsets.only(top: 8.0)),
