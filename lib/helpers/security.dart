  ...
  Widget build(BuildContext context) {
    Widget sections = Container(
      child: Column(
        ...
        children: <Widget>[
          _buildsection(
              context, "Macalester Security: 24 hour", "651-696-6555"),
          _buildsection(
              context, "Macalester Security: business hours", "651-696-6278"),
          _buildsection(context, "Macalester Security: fax", "651-696-6135"),
          _buildsection(
              context, "Interim Title IX Coordinator", "651-696-6258"),
          _buildsection(
              context, "Counselors at Protocall", "651-696-6275 (Press 2)"),
          _buildsection(
              context, "Urgent Care for Mental Health", "651-266-7900"),
